...
$$
\text{Total Execution Time} = 15 [s] \times N + 94 [s] + \left(\frac{\mathrm{FWHM}}{7.3 [\text{km/s}]}\right)\left(\frac{N}{100}\right) \times 76 [s]
$$
...
| CC1 | Apple M4 PRO (2024) | SNAKY (1.0.1) | 3.12.15_latest | 01 min 40 s  | 01 min 36 s  |
