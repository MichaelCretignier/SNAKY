...
mask_broadline = [[3920,3945],   # a list of left and right borders to eliminate from the anchor point candidates
                  [3960,3980],
                  [6560,6562],   
                  [10034,10064]] 
...
count_out_lim = 5       # number of outliers clipping in automatic mode (put at least 1 if Automatic mode)
