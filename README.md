...
**WARNING: The `output_directory` must contain only files generated by SNAKY. Do not reuse an existing directory. Always create a new, dedicated output directory for SNAKY.**
